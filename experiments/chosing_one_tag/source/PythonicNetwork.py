...
class TestNetwork(object):
    ...
    def __init__(self, OUTPUTNEURONS, prototxt_base, prototxt_ready, model_file, max_batch_size, imshape, map_template2file):
        ...
        self.map_template2file = map_template2file
    ...
    def _prepareDeployPrototxts_(self, prototxt_base):
        ...
        new_prototxt = PrototxtTemplate(prototxt_base, self.map_template2file)
